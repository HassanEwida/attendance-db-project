...
import jellyfish
import pandas as pd
from get_csv_files import get_files, get_files_from_host
from attendance_from_csv import insert_to_db
...
if __name__ == '__main__':
    ...
    new_df.to_csv('attendance.csv', encoding='utf-16-le-encode')
